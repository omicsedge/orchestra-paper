...
python /scripts/filter_variants.py --vcf-file dataset.vcf --remove-variants-file remove_variants.txt --output-file aux && mv aux dataset.vcf
...
python /scripts/generate_founder_labels.py \
