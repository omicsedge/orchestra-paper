...
cp /code/simulation/scripts/SLiM.reproduce_pedigree.recipe SLiM.torun
...
python3 /code/simulation/app/extract_tree_info.py \
...
python /code/simulation/app/generate_labels.py \
