...
##############################################
# Please Read Before Executing This Step:
# --------------------------------------
# The LAI results, which include local ancestries per window, can be found in the summary-results/ directory, generated by Orchestra.
# The final results, following the base and smoothing layer, are located in the files named smooth_samples.chr*.tsv.gz.
#
###############################################
...
analysis_folder <- ''
orchestra_results_folder <- paste0(analysis_folder, '/LAI_results') # LAI results from Orchestra (smooth_samples.chr*.tsv.gz files under summary-results/)
...
ancestry_label <- 'NAM' # Here, European ancestry for Mexicans, but it could be something else for other admixed populations
